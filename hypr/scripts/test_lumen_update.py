#!/usr/bin/env python3
"""
Self-test for lumen-update.py against throwaway git repos in a temp dir. No
...
spec = importlib.util.spec_from_file_location("lumen_update", HERE / "lumen-update.py")
